...
$.extend($.validator, {
	...
	messages: {
		...
		equalTo: "Ingrese el mismo valor",
                ...
                maxField: "Debe ser menor o igual a la Cantidad",
                minField: "Debe ser mayor o igual a la Cantidad",
                letter: "Sólo Letras",
	...
	methods: {
		...
		equalTo: function( value, element, param ) {
			...
			return value === target.val();
                ...
                maxField: function(value, element, param) {
                    return value <= $(param).val();
                },
                        
                minField: function(value, element, param) {
                    return value >= $(param).val();
                },
